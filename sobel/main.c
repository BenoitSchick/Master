	  ...
	  if (new_image_available() != 0) {
		  if (current_image_valid()!=0) {
		      ...
		      default:
		    	  ...
		    	  //L'id�e est de traiter une sous-image 240x320 de l'image de la camera

		    	  //--> row = picture + y*width(512)  avec y de 0 � 320 --> on parcourt 320 lignes au lieu de 384
		    	  //--> row[x] avec x de 0 � 240  --> on parcourt 240pixels/ligne au lieu de 520
